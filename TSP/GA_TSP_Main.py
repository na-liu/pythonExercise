# -*- encoding: utf-8 -*-
# TSP问题GA求解包
from TSP.GA import GAList
from TSP.MyFuncTool import GetData, ResultShow, draw


class TSP(object):
    def __init__(self, Dist, CityNum):
        """ 构造函数 """
...
if __name__ == '__main__':
    CityNum, Dist = GetData("./data/gr48.txt")
    tsp = TSP(Dist, CityNum)
    generate = 100
